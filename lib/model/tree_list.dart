...
class TreeListModel {
  ...
  TreeListModel.fromParams({this.errorCode, this.errorMsg, this.data});

  factory TreeListModel(jsonStr) => jsonStr == null ? null : jsonStr is String ? new TreeListModel.fromJson(json.decode(jsonStr)) : new TreeListModel.fromJson(jsonStr);

  TreeListModel.fromJson(jsonRes) {
